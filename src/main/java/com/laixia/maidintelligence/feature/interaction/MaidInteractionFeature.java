...
public final class MaidInteractionFeature implements FeatureModule, TlmFeatureModule {
    ...
    public void initialize(FeatureContext context) {
        ...
        DistExecutor.unsafeRunWhenOn(
                Dist.CLIENT,
                () -> () -> ClientInteractionSetup.initialize(context.modEventBus())
        );
    }
    ...
    public void registerMaidTips(MaidTipsOverlay overlay) {
        overlay.addTips("overlay.maid_intelligence.interaction.empty_hand", Items.AIR);
        overlay.addTips(
                "overlay.maid_intelligence.interaction.feed_aim",
                Items.GOLDEN_APPLE,
                Items.ENCHANTED_GOLDEN_APPLE
        );
        overlay.addTips("overlay.maid_intelligence.interaction.potion", Items.POTION);
        overlay.addTips("overlay.maid_intelligence.interaction.milk", Items.MILK_BUCKET);
        overlay.addTips("overlay.maid_intelligence.interaction.glass_bottle", Items.GLASS_BOTTLE);
        overlay.addSpecialTips(
                "overlay.maid_intelligence.interaction.feed",
