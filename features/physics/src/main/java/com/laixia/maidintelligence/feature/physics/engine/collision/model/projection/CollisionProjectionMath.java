...
/**
 * Narrow cross-package service for fixed-length projection primitives.
 */
final class CollisionProjectionMath {
    ...
    static boolean projectMinimumDot(
        ...
        /*
         * Near-axis bounds demand a large turn for negligible clearance, so
         * keep the requested direction short of the contact normal.
         */
    ...
    static boolean projectOutsideSphere(
        ...
        return projectMinimumDot(direction, normal, minimumDot, tangent);
    }
