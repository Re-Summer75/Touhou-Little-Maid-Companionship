package com.laixia.maidintelligence.feature.physics.engine.collision.bake.automatic;
...
/**
 * Conservative Y-axis capsule derived from an AABB.
 */
public record CapsuleFit(
    ...
    public static CapsuleFit fromBounds(
        ...
        if (cylinderRadius <= EPSILON
            ...
            float sphereRadius = Math.max(cylinderRadius, halfY * 0.90F);
