 ...
 */
final class RuntimeBoneEndpoints implements CollisionFrameSource {
     ...
     */
    @Override
    public Matrix4f renderedTransform(int nodeIndex) {
        return renderedTransforms[nodeIndex];
    }

    @Override
    public boolean hasRenderedTransform(int nodeIndex) {
        return nodeIndex >= 0
